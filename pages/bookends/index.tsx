import { RobeInfo, fetchRobes } from '../api/bookends'
...
const IndexPage = ({ robes, lastUpdate }: Props) => {
  return (
    <div className="py-3 md:pb-0 font-mono flex flex-col justify-center items-center gap-4 pt-10 md:w-screen">
      <h1 className="text-lg md:text-3xl">📚 Bookends 📚</h1>
      <div className="text-center max-w-screen-md md:leading-loose">
        <p className="md:text-xl">
          There are {robes.length} N's for sale that start with the same two numbers that they end with. There are 9/8888 bookends in the N Project. The floor
