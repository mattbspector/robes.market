import { RobeInfo, fetchRobes } from '../api/scatter-5'
...
const IndexPage = ({ robes, lastUpdate }: Props) => {
  return (
    <div className="py-3 md:pb-0 font-mono flex flex-col justify-center items-center gap-4 pt-10 md:w-screen">
      <h1 className="text-lg md:text-3xl">Scatter 5x</h1>
      <div className="text-center max-w-screen-md md:leading-loose">
        <p className="md:text-xl">
          There are {robes.length} N's for sale with the same number appearing 5x. There are 42/8888 Scatter 5xs in the N Project. The floor
