...
export async function getStaticProps() {
  const data = await fetchNs('divineRobes')
  return {
    props: {
      robes: data.robes,
    ...
    <div className="py-3 md:pb-0 font-mono flex flex-col justify-center items-center gap-4 pt-10 md:w-screen">
      ...
      <div className="text-center max-w-screen-md md:leading-loose">
        <p className="md:text-xl">
          There are {robes.length} Adventure Card Starter Decks for sale containing a Divine Robe. The floor price is {robes[0].price} ETH.
        </p>
